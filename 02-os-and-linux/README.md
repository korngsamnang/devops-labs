...
-   Acts as an abstraction layer between applications and hardware
    -   Prevents apps from needing to interact directly with hardware
    -   Enables apps to run on different hardware configurations

## Key Tasks of an Operating System

### 1. Resource Management

| Resource | Management Function               |
| -------- | --------------------------------- |
| CPU      | Process scheduling and allocation |
| RAM      | Memory allocation to applications |
| Storage  | File system management (HDD/SSD)  |

### 2. File Management

-   Organizes files in hierarchical directory structures
-   Different systems:
    -   Unix/Linux: Single root (`/`)
    -   Windows: Multiple roots (`C:`, `D:`)

### 3. Device Management

-   Handles communication via device drivers
-   Manages device access for processes

### Additional Functions

-   **Security**: User permissions and access control
-   **Networking**: Port/IP address management

## OS Architecture Components

### Kernel

-   Core OS component loaded at startup
-   Responsibilities:
    -   Process management
...
| ------ | ------------------------------- | ------------------- |
| Client | GUI-focused, personal computing | Windows, macOS      |
| Server | Lightweight, CLI-focused        | Linux distributions |

### Unix vs Linux

| Unix                 | Linux                  |
| -------------------- | ---------------------- |
| Original (1970)      | Clone (1991)           |
| Proprietary variants | Open-source            |
| macOS based on Unix  | Android based on Linux |
...
-   Software-based computers running on host hardware
-   Benefits:
    -   Isolation from host system
    -   Resource allocation control
    -   OS portability (via VM images)
...
| Cloud provider standard   | Development/testing            |
...
-   Hidden files prefixed with `.` (dotfiles)
